...
def test_dense():
    ...
    # actual_num = 2.986982345
    # desired_num = 2.98698237

    # assert_allclose(actual_num, desired_num, rtol=3e-0)
    # assert_allclose(hls_prediction,keras_prediction, rtol=3e-0)
...
def test_conv1d():
    ...
    print(model.layers[0].__dict__.items())
    print()
...
#   added = tf.keras.layers.Concatenate()([x1, x2])
...
#     # assert list(hls_model.get_layers())[6].attributes['op'] == model.layers[4]._name.lower() + '{}d'.format(rank)
...
#   # print()
#   # list(hls_model.get_layers())[6].attributes['op']
#   # # print(list(hls_model.get_layers())[6].attributes)
#   # print()
#   print(model.layers[4].__dict__.items())
